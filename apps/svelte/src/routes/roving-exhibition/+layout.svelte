<script lang="ts">
  ...
  import SplitPaperLayout from "$lib/components/layouts/SplitPaperLayout.svelte";
...
<MainHeader />
<SplitPaperLayout title="Roving Exhibition" desc="Explore our travelling exhibitions and uncover fascinating stories about our rich, multiracial and multicultural heritage." >
    {@render children?.()}
</SplitPaperLayout>
